...
public class FusionCharts {
    ...
    //构造器FusionCharts("type of chart", "unique chart id", "width of chart", "height of chart", "div id to render the chart", "data format", "data source")
    public FusionCharts(String type, String id, String width, String height, String renderAt, String dataFormat, String dataSource) {
        ...
        /**
         * this.chartOptions[5]可能的方式：json、jsonurl、csv、xml、xmlurl
         * 如果包含url的话：
         * 如果不包含url的话：
         */
        if (this.chartOptions[5].contains("url")) {
            this.chartOptions[6] = "\"" + dataSource + "\"";  //"\""   等于  "
        } else {
