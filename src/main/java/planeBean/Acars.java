...
public class Acars {
    ...
    static String colFamilyName;
    static String values;
    HBaseConnection hBaseConnection = new HBaseConnection();

    public Acars(String tableName1, String colFamilyName1, String value1) throws IOException {
    ...
    public void putToTable() throws IOException, ClassNotFoundException {
        ...
        //插入一行
        Put put = new Put(Bytes.toBytes(id + msgid));
        put.addColumn(Bytes.toBytes(colFamilyName), Bytes.toBytes("id"), Bytes.toBytes(id));
