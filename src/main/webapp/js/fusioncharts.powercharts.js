...
(function (J) {
    ...
    J.register("module", ["private", "modules.renderer.js-gradientlegend", function () {
        ...
        var Q = this, n = Q.hcLib, b = n.pluckNumber, z = n.pluck, f = n.toRaphaelColor, K = n.graphics, V = n.dehashify, m = n.hashify, Z = K.convertColor, ga = K.RGBtoHex, L = K.HEXtoRGB, w = K.getLightColor, U = K.getValidColor, g = "rgba(192,192,192," + (n.isIE ? .002 : 1E-6) + ")", y, P = n.COLOR_BLACK, ka = {}.hasOwnProperty, d, N = {};
        y = function () {
            function d(k) {
        ...
        W.prototype.getBoundingBox = function (d) {
            var h = this.conf, q = d.refSide, k = d.alignment, t = d.refOffset, O = d.x, x = d.y, h = h.width = q * h.spreadFactor;
        ...
        W.prototype.draw = function (d) {
            var h = this.conf, q = this.compositionsByCategory, k = d.paper, t = d.parentGroup, O = d.componentPool, x, p, G = O.getChart().get("config", "animationObj").duration, u, b = O.getKeys();
        ...
        S.prototype.getBoundingBox = function (d) {
            var h = this.conf, q = d.refSide, k = d.alignment, t = d.refOffset, O = d.x, x = d.y, h = h.height = q * h.spreadFactor;
        ...
        B.prototype.draw = function () {
            var d = this.childTextConf, h = this.conf.bound.style || {}, q = this.compositionsByCategory, k, t, O, x, p, G, u;
        ...
        r.prototype.constructor = r;
        r.prototype.getLogicalSpace = function (d, h, q) {
            var k = this._lSpace, t = this.conf, O = t.padding, x = h.componentPool.getChart(), p, G, u, b, g, f, w = [], L, y,
                U, P;
            if (k && !q)return k.isImpure = !0, k;
            k = h.colorRange;
            h = h.smartLabel;
        ...
        D.prototype.getLogicalSpace = function (d, h, q) {
            var k = this._lSpace, t = this.conf, O = t.padding, x = h.componentPool.getChart(), p, G, u, b, g, f, w = [], L, y, U, P;
            if (k && !q)return k.isImpure = !0, k;
            k = h.colorRange;
            h = h.smartLabel;
            q = k.colorRange;
        ...
        v.prototype.draw = function () {
            var d, h = this.conf, q = h.line, k = (h.bound || {}).style || {}, t, O, x = this.compositionsByCategory, p, G, u, b, g, f;
        ...
        F.prototype.draw = function (d, h, q) {
            var k = this.sliders, t = k[!1], k = k[!0], b = q.colorRange, x = b.colorRange, p = this._fcChart = q.componentPool.getChart();
        ...
        l.prototype.draw = function (d, h, q, k) {
            var t = k.parentLayer, b = this.conf, x = b.outerCircle, p = b.innerCircle, G = Math.ceil(x.rFactor * k.rCalcBase / 2), u = Math.ceil(p.rFactor * k.rCalcBase / 2), f = G - u, w = this.rangeGroup, L = this.sliderIndex, a, y, U = k.componentPool, P = U.getKeys();
            b.outerRadius = G;
            b.innerRadius = u;
            this._scaleVal = h;
        ...
        J.register("component", ["gradientLegend", "gradientLegend", {
            pIndex: 1, enabled: !1, init: function (b) {
                ...
                var d = this._chart, h = d.jsonData.chart, q = this.conf = {}, k = h.outcnvbasefont, t = h.outcnvbasefontsize, g = h.outcnvbasefontcolor, d = d.config.dataLabelStyle, x, p, G, u, f, w, a;
    ...
    J.register("module", ["private", "modules.renderer.js-msstepline", function () {
        var a = this.hcLib, c = this.window, E = !a.CREDIT_REGEX.test(c.location.hostname), e = a.chartAPI, ba = a.pluckNumber, W = a.pluck,
            S = c.Image, c = a.preDefStr, I = a.schedular, B = c.line, X = a.toRaphaelColor, M = a.getFirstValue, R = c.configStr, r = c.animationObjStr, D = c.dataLabelStr, v = a.BLANKSTRING, A = c.hiddenStr, F = Math.max, l = a.TOUCH_THRESHOLD_PIXELS, C = a.CLICK_THRESHOLD_PIXELS, H = a.hasTouch ? l : C, Q = c.ROUND, n = c.miterStr;
        e("msstepline", {
        ...
        J.register("component", ["dataset", "MSStepLine", {
            type: "msstepline", _addLegend: function () {
                ...
                var b = this, z = b.JSONData, f = b.chart, l = f.getJobList(), V = f.components, m = b.config, Z = b.index || b.positionIndex, ga = f.config, L, w, U = V.paper, g = V.xAxis[0], y = b.yAxis,
                    P, ka, d = f.graphics;
                L = d.datalabelsGroup;
                var N, T, h, q, k, t, O = b.components.data, x, p = b.components.removeDataArr || [], G = p.length, u = m.linethickness, da = b.graphics.container, ma = ga.connectnulldata, La = d.datasetGroup, aa, d = m.shadow, db, c = b.graphics.dataLabelContainer, ta = {}, C, e, ta = f.get(R, r), Qa = ta.dummyObj, Ea = ta.animObj, M = ta.duration, E = b.components.pool || [], ba = function () {
                    ...
                    }, Na = !0, Ra, Va = y.getAxisBase(), Va = y.yBasePos = y.getAxisPosition(Va), Da = V.canvas.config.clip, V = Da["clip-canvas-init"].slice(0), Da = Da["clip-canvas"].slice(0), J = m.lineDashStyle, va = {
                        color: m.linecolor,
                        alpha: m.alpha
                    },
                    Fa, wa, oa, qa, la = [], ia = 0, ea = [], sa = null, fa, ha = [], ca = !1, Aa, ya = b.graphics.lineElement, Y = b.visible, ua = m.drawverticaljoins, xa = m.useforwardsteps, za, Ga = ta.animType, Ma = 0, ra, f = f.config.stepatmiddle ? .5 * g.getPVR() : 0, Ba, Ua = ga.canvasTop, Ja = ga.canvasBottom;
                m.imagesLoaded = 0;
    ...
    J.register("module", ["private", "modules.renderer.js-powercharts", function () {
        ...
        c.addSymbol({
            resizeIcon: function (a, c, e) {
                ...
                var M = 1.3 * e, E = 43 * S, r = 48 * S, D = a + M * W(E), E = c + M * ba(E), v = a + M * W(r), A = c + M * ba(r), r = .71 * (e - 2);
                e = .71 * (e - 2);
                M = ["A", M, M, 0, 1, 0, v, A];
                D = ["M", D, E];
                D = D.concat(M);
                ...
                e = c + e;
                var A =
                    a + .5, F = c + .5, l = a - .5, C = c - .5, H = r - 2, Q = D - 2, n = v + 2, b = e + 2, z = a + M, f = c + M, K = a - M, M = c - M, V = a + E, m = c + E;
                a -= E;
                c -= E;
    ...
    J.register("module", ["private", "modules.renderer.js-splinearea", function () {
        var a = this.hcLib, c = a.HUNDREDSTRING, E = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
        a("splinearea", {
    ...
    J.register("module", ["private", "modules.renderer.js-multiaxisline", function () {
        var a = this.hcLib, c = this.window, E = a.pluck, e = a.pluckNumber, ba = a.preDefStr, W = ba.sStr, S = a.BLANKSTRING, I = a.parseUnsafeString, B = ba.defaultFontStr, X = a.pluckFontSize, M = ba.divLineAlphaStr, R = ba.divLineAlpha3DStr, r = a.componentDispose, D = a.chartPaletteStr = {
            chart2D: {
                bgColor: "bgColor",
                bgAlpha: "bgAlpha",
                bgAngle: "bgAngle",
        ...
        }, c = !a.CREDIT_REGEX.test(c.location.hostname), v = a.graphics.convertColor, A = a.extend2, F = ba.altVGridColorStr, l = ba.configStr, C = ba.animationObjStr, H = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")", Q = a.toRaphaelColor, n = a.hasTouch, b = Math, z = b.max, f = b.min, K = ba.POSITION_BOTTOM, V = ba.colors.c000000, m = ba.altVGridAlphaStr, a = a.chartAPI;
        a("multiaxisline", {
            ...
            _createDatasets: function () {
                var b = this.components, a = this.config, f = this.jsonData, w = f.axis, U, g, y, P, n = 0, d, N, T = this.defaultDatasetType, h = this.applicableDSList, q = b.legend.components.items || [], k, t, O, x, p = this.config.isstacked, G, u = {}, da = 0, ma;
                if (w) {
                    U = w.length;
            ...
            _feedAxesRawData: function () {
                var b = this.components, a = this.config, f = b.colorManager, w = b.numberFormatter, U = this.jsonData, g = U.chart, y, P, n = this.is3d;
            ...
            _setAxisLimits: function () {
                var b = this.components, a = this.config.axisDataSetMap, L = b.dataset, b = b.yAxis, w = a.length, U, g = -Infinity, y =
                    Infinity, n, r, d;
                for (U = 0; U < w; U += 1) {
                    n = 0;
            ...
            _spaceManager: function () {
                ...
                a = g.legend;
                var d = w.axesPadding, N = 0, T = 0, h = w.axisDataSetMap.length, q, k, t, O = this.jsonData.chart, x = e(O.showborder, this.is3D ? 0 : 1), g = g.canvas.config.canvasBorderWidth;
                q = w.borderWidth = x ? e(O.borderthickness, 1) : 0;
                var p = w.canvasMarginTop, G = w.canvasMarginBottom, u = w.canvasMarginLeft, O = w.canvasMarginRight, da = w.height, x = w.width;
            ...
            _postSpaceManagement: function () {
                var b = this.config, a = this.components, f = a.xAxis && a.xAxis[0], w = a.legend,
                    U = b.xDepth, g = a.canvas.config, a = g.canvasBorderWidth, y = g.canvasPadding, n = g.canvasPaddingLeft, g = g.canvasPaddingRight;
            ...
            _drawAxis: function (b) {
                var a = this.config, f = a.axesArr, w = this.components, U = w.yAxis || [], g = w.xAxis || [], y = w.paper, P = a.allowAxisShift, r = a.allowSelection, d = this.graphics.axisHotElement || [], N = this.graphics.trackerContainer, T = this.graphics.buttonGroup, h = w.canvas.config, q = h.canvasBorderWidth, k = h.canvasPaddingTop, h = h.canvasPaddingBottom, t = a.axesPadding, O = this.components.tb, x = 0, p = 0, G = 0, u, da, ma, m,
    ...
    J.register("module", ["private", "modules.renderer.js-logmsline", function () {
        var a = this.hcLib, c = a.preDefStr.line, E = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
        a("logmsline",
            {
                standaloneInit: !0,
    ...
    J.register("module", ["private", "modules.renderer.js-logmscolumn2d", function () {
        var a = this.hcLib, c = a.preDefStr.column, E = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
        a("logmscolumn2d", {
    ...
    J.register("module", ["private", "modules.renderer.js-multilevelpie", function () {
        var a = this.hcLib, c = a.chartAPI, E = !a.CREDIT_REGEX.test(this.window.location.hostname), e = a.parseUnsafeString,
        ...
        c("multilevelpie", {
            ...
            hasCanvas: !1,
            _createDatasets: function () {
                var a = this.components, c = this.jsonData, E = c.dataset || [], M = E.length, R, r, D = this.defaultDatasetType, v = this.applicableDSList, A;
                R = [];
                var F = {};
    ...
    J.register("module", ["private", "modules.renderer.js-dragbase", function () {
        var a = this, c = a.hcLib, E = a.window, e = E.document, ba = c.preDefStr, W = ba.colors.FFFFFF, S = c.ZEROSTRING, I = ba.UNDERSCORE, B = c.BLANKSTRING, X = c.BLANKSTRING, M = c.pluck,
            R = c.getValidValue, r = c.pluckNumber, D = c.extend2, v = c.hasSVG, A = c.isIE, F = c.regex.dropHash, l = c.HASHSTRING, C = c.schedular, H = c.priorityList, Q = function (b, a) {
                var f;
                b || (b = {});
                for (f in a)b[f] = a[f];
                return b
            }, n = c.addEvent, b = c.removeEvent, ba = Math, z = ba.min, f = ba.max, K = c.hasTouch, V = c.graphics.convertColor, m = c.chartAPI, Z = a.xssEncode, ga = c.createElement;
        m("dragbase", {
            configure: function () {
                ...
                var b = this, w = b.components.tb || (b.components.tb = new (J.register("component", ["toolbox", "toolbox"]))), n, g, y, P = b.components, c, d, N, z = b.linkedItems.smartLabel, h = b.config, q = h.showRestoreBtn, k = h.formAction,
                    t = h.restoreBtnTitle, O = h.submitBtnTitle, x = h.formBtnStyle, p = h.restoreBtnStyle, G = h.restoreBtnWidth, u = h.restoreBtnBgColor, da = h.restoreBtnBorderColor, ma = h.formBtnBgColor, r = h.formBtnBorderColor, aa = h.restoreBtnLabelFill, l = h.formBtnLabelFill, v = h.btnSpacing, K = h.btnPadding, Z = h.formBtnWidth;
                n = P.chartMenuBar;
                d = P.actionBar;
                ...
                var b = this, a = b.chartMenuTools, f = b.components, g = f.actionBar, f = (f.chartMenuBar || g).componentGroups[0].symbolList[0].getListRefernce(), g = r(b.jsonData.chart.allowaxischange, 1), a = a.set, y = [{
            ...
            drawAxisUpdateUI: function () {
                var a = this, f = a.graphics, U = a.components.yAxis[0], g = U.config.axisRange, y = U.getAxisConfig("extremeLabels") || [], U = a.config, P = g.min, g = g.max, z = y.lastLabel.graphic, d = y.firstLabel.graphic, N = a.linkedItems.container, y = Q({
                        outline: "none",
                ...
                var a = this.components, f = a.yAxis[0], g = f.config.axisRange, y = g.min, n = g.max, c = this.config.yMax, g = !1, d = this.graphics.hiddenAxisLabels || [], z = d.length;
                ...
                var a = this.components, f = a.yAxis[0], g = f.config.axisRange, n = this.config.yMin, c = g.max, z, d = !1, N = this.graphics.hiddenAxisLabels ||
                    [], r = N.length, g = g.min;
            ...
            eiMethods: {
                getDataWithId: function () {
                    ...
                    var f = this.jsVars.instanceAPI,
                        n = f.getJSONData(), g = [[B]], y = n.dataset, c = n.categories && n.categories[0] && n.categories[0].category, z = y && y.length || 0, d = 0, r, m;
                ...
                var b = this.components, a = b.yAxis[0], f = b.dataset, b = b.legend, g = f.length, n, z = this.graphics.hiddenAxisLabels ||
                    [], r;
                ...
                var a = this.chartInstance, f = new b.ajax, g = this.config, n = b.dataFormats.JSON, z = b.dataFormats.CSV,
                    r = b.dataFormats.XML, d = g.formAction, N = this.chartInstance, m = g.submitFormAsAjax, h, q, k, t, O;
                ...
                var b = this.defaultDatasetType && this.defaultDatasetType.toLowerCase(), a = this.components, f = a["datasetGroup_" + b], b = a.dataset, g = this.jsonData.dataset, n, c = this.jsonData, z = b.length, a = [], d;
                ...
                var a = b.data.mouseTracker, f = this.config, g = f.canvasLeft, n = f.canvasRight, z = f.canvasBottom, r = f.canvasTop, d = f.datasetOrder || this.components.dataset, N = c.getMouseCoordinate(this.linkedItems.container, b.originalEvent, this), m = N.chartX,
                    h = N.chartY, q, k, t = !1, O = d.length, x, p = a._lastDatasetIndex, N = a._lastPointIndex, G, f = f.dragTolerance || 0;
    ...
    J.register("module", ["private", "modules.renderer.js-dragnode", function () {
        var a = this, c = a.hcLib, E = c.ZEROSTRING, e = c.pluck, ba = c.getValidValue, W = c.pluckNumber, S = c.extend2,
            I = c.componentDispose, B = Math, X = B.min, M = B.max, B = !c.CREDIT_REGEX.test(a.window.location.hostname), R = c.chartAPI;
        R("dragnode", {
            ...
            _createDatasets: function () {
                var a = this.config, c = this.components, v = this.jsonData, A = v.dataset, e = v.connectors, l = v.labels && v.labels.label || [], C = A && A.length, H = e && e.length, Q = l && l.length || [], n = c.legend,
                ...
                var U = a.datasetMap || (a.datasetMap = {
                        ...
                        dragnode: [],
                        labels: []
                    }), g, y = {connectors: [], dragnode: [], labels: []}, P = {};
                if (A) {
            ...
            addConfigureOptions: function () {
                var a = this.chartMenuTools, c = this.components, v = c.actionBar, A = this.components["datasetGroup_" + this.defaultDatasetType], c = (c.chartMenuBar || v).componentGroups[0].symbolList[0].getListRefernce(), a = a.set, v = this.config.viewMode,
                    e = [{
                        "Add Node": {
                            handler: function () {
                                A.showNodeAddUI()
            ...
            updateNode: function (c) {
                var e = this.components["datasetGroup_" + this.defaultDatasetType], v = e.datasets, A = v.length, F, l, C, H, Q, n, b;
                c.update = !0;
            ...
            deleteNode: function (r) {
                var e = this.components["datasetGroup_" + this.defaultDatasetType].nodes, v = e[r], A, F, l, C, H, Q, n, b, z = function (b) {
            ...
            addConnector: function (c) {
                var e = this.components["datasetGroup_" + this.defaultDatasetType], v = e.connectorSet[0].connectors, A = v.components.data.length;
                c.add = !0;
                v._setConfigure(A, c);
                c = {
            ...
            deleteConnector: function (r) {
                var e = r.from;
                r = r.to;
                var v = this.components["datasetGroup_" + this.defaultDatasetType].connectorSet, A, F, l, C, H, Q = !1, n = v.length;
            ...
            addLabel: function (c) {
                var e = this.components["datasetGroup_" + this.defaultDatasetType], v = e.labelSet, A = J.get("component", ["dataset", "DragableLabels"]);
                c.add = !0;
            ...
            restoreData: function () {
                var a = this.components["datasetGroup_" + this.defaultDatasetType], e = a.datasets, v = this.components.legend, A = a.connectorSet, F, l, C, H, Q = a.labelSet, n = function (b) {
                    var a, f;
            ...
            getJSONData: function () {
                var a = this.defaultDatasetType && this.defaultDatasetType.toLowerCase(), c = this.components, e = c["datasetGroup_" + a], a = c.dataset, A = this.jsonData, F = a.length, c = [], l;
            ...
            _setCategories: function () {
                var a = this.jsonData, c = this.components.xAxis, a = a.categories && a.categories[0].category || [], e = a.length, A = [], F, l;
            ...
            _setAxisLimits: function () {
                var a = this.components, c = this.jsonData, c = c.categories && c.categories[0].category || [], v, A = a.dataset, F = a.yAxis,
                    a = a.xAxis, l, C = A.length, H, Q = -Infinity, n = Infinity, b = Infinity, z = -Infinity, f, K, V = {}, m = [], Z = function (a) {
                        f = e(a.xMax, -Infinity);
                        K = e(a.xMin, Infinity);
                        Q = M(Q, a.max);
                        n = X(n, a.min);
    ...
    J.register("module", ["private", "modules.renderer.js-selectscatter", function () {
        var a = this, c = a.hcLib, E = a.window, e =
            !c.CREDIT_REGEX.test(E.location.hostname), ba = c.getValidValue, W = c.extend2, S = c.toRaphaelColor, I = c.preDefStr, B = c.hasSVG, X = c.BLANKSTRING, M = I.ROUND, R = Math, r = R.min, D = R.max, v = R.abs, A = a.xssEncode, F = I.hiddenStr, R = I.visibleStr, l = 8 === E.document.documentMode ? R : X, C = I.configStr, H = "rgba(192,192,192," + (c.isIE ? .002 : 1E-6) + ")", Q = c.chartAPI;
        Q("selectscatter", {
            isXY: !0,
            hasLegend: !0,
            ...
            createSelectionBox: function (a) {
                var b = a.chart, c = b.components, f = c.paper, e = b.config, r = c.yAxis && c.yAxis[0], c = c.xAxis && c.xAxis[0], m = a.selectionLeft, Z = a.selectionTop, v = a.selectionWidth;
                a = a.selectionHeight;
            ...
            start: function () {
                var a =
                    this.data(C).selectEleObj, b = a.topTracker, c = a.rightTracker, f = a.bottomTracker, e = a.leftTracker, l = a.resizeTracker, m = b.data(C), r = c.data(C), v = f.data(C), L = e.data(C), w = l.data(C), U = a.selectBoxTracker.data(C), g = a.selectBoxTracker.getBBox();
                m.ox = g.x;
                m.oy = g.y;
                r.ox = g.x2;
                r.oy = g.y;
            ...
            move: function (c,
                            b) {
                var z = b[0], f = b[1], e = this.data(C), l = e.selectEleObj, m = l.chart, Z = m.config, H = m.components, L = l.topTracker, w = l.rightTracker, U = l.bottomTracker, g = l.leftTracker, y = l.resizeTracker, P = l.selectBoxTracker, A = l.canvasLeft, d = l.canvasRight, N = l.canvasTop, T = l.canvasBottom, h = P.data(C), q = {}, z = e.xChange ? z : 0, f = e.yChange ? f : 0, z = z + e.ox, f = f + e.oy, z = r(d - (e.ow || 0), D(z, A)), f = r(T - (e.oh || 0), D(f, N));
                switch (e.position) {
                    case 1:
                        q.y = r(h.oy2, f);
            ...
            up: function () {
                var c = this, b = c.data(C).selectEleObj, z = b.chart, f = z.components, e = z.config, l = f.xAxis && f.xAxis[0], m = f.yAxis && f.yAxis[0], r = b.topTracker, v = b.rightTracker, L = b.bottomTracker, w = b.leftTracker, U = b.resizeTracker,
            ...
            submitData: function () {
                var n = this.chartInstance, b = new a.ajax, z = this.config, f = a.dataFormats.JSON, e = a.dataFormats.CSV, l = a.dataFormats.XML, m = z.formAction || "", r = z.submitFormAsAjax,
                    v, L, w, U, g;
    ...
    J.register("module", ["private", "modules.renderer.js-candlestick", function () {
        var a = this.hcLib, c = !a.CREDIT_REGEX.test(this.window.location.hostname), E = a.chartAPI, e = a.pluck, ba = a.graphics.convertColor, W = a.preDefStr, S = W.altHGridColorStr, I = W.altHGridAlphaStr, B = a.parseUnsafeString, X = W.column, M = a.componentDispose, R = W.volume, r = a.POSITION_RIGHT, D = Math, v = D.max, A = D.round, F = W.POSITION_BOTTOM, l = W.configStr, C = W.animationObjStr, H = W.ROUND, Q = W.miterStr, n = a.toRaphaelColor, b = W.divLineAlpha3DStr, z = W.defaultFontStr, f =
            a.pluckFontSize, K = W.divLineAlphaStr, V = W.altVGridColorStr, m = W.altVGridAlphaStr, Z = D.min, ga = W.colors.c000000, L = a.BLANKSTRING, w = a.chartPaletteStr = {
            chart2D: {
                bgColor: "bgColor",
                bgAlpha: "bgAlpha",
                bgAngle: "bgAngle",
        ...
        E("candlestick", {
            ...
            _createDatasets: function () {
                var b = this.config, a = this.components, f = this.jsonData, d = f.dataset, g = f.trendset || [], c = this.config.showVolumeChart, h = d && d.length, q, k, t = this.defaultDatasetType, O =
                    e(B(f.chart.plotpriceas), X), x, p, G, u, n, w = 0, z = b.datasetMap || (b.datasetMap = {
                        trendset: [],
                        candlestick: []
                    }), aa, m = {}, l = {trendset: [], candlestick: []}, L = a.legend;
                if (d) {
                    this.config.categories = f.categories && f.categories[0].category;
                    q = a.dataset = [];
                    f = 0;
            ...
            _spaceManager: function () {
                var b, a, f, d = this.config, g = this.components, c = d.legendPosition, h = g.xAxis && g.xAxis[0], q = g.xAxis && g.xAxis[1], k = g.yAxis && g.yAxis[0], t = g.yAxis && g.yAxis[1];
                a = this.hasLegend;
                var O = g.legend, x, p = this.config.showVolumeChart, G = p ? d.volumeHeightPercent : 0, u = g.canvas.config, n = g.canvasVolume.config, w =
                    d.width, z = d.height, aa = {};
                b = d.chartBorderWidth;
                g = g.canvas.config.canvasBorderWidth;
                x = d.minCanvasHeight;
                f = d.minCanvasWidth;
                var e = d.canvasMarginLeft, m = d.canvasMarginRight, l = d.canvasMarginTop, L = d.canvasMarginBottom, U, H, Z = d.origCanvasTopMargin, Q = d.origCanvasBottomMargin, V = d.origCanvasLeftMargin, K = d.origCanvasRightMargin;
            ...
            _postSpaceManagement: function () {
                var b = this.components, a = this.config.showVolumeChart, f = b.xAxis && b.xAxis[0], d = b.yAxis && b.yAxis[0], g = b.xAxis && b.xAxis[1], c = b.yAxis && b.yAxis[1], h = b.canvas.config, q = b.legend, b = b.canvasVolume.config, k = h.canvasBorderWidth;
                f && f.setAxisDimention({
                    x: h.canvasLeft,
                    y: h.canvasY,
            ...
            _drawCanvas: function () {
                var b = this.components, a = this.graphics, f = b.paper, d = b.canvas, g = b.canvas.config, c = g.clip || (g.clip = []), h = b.canvasVolume.config,
                    q = d.graphics, b = b.canvasVolume.graphics, k = d.config, t = q.topCanvas, O = q.topCanvasBorderElement, d = b.volumeCanvas, x = g.canvasLeft, p = g.canvasTop, G = g.canvasWidth, g = g.canvasHeight, u = h.canvasTop, h = h.canvasHeight, a = a.canvasGroup, w = k.canvasBorderRadius, z = k.canvasBorderWidth, e = .5 * z, aa = k.canvasBorderColor, m = this.get(l, C), L = m.dummyObj, U = m.animObj, r = m.animType, m = m.transposeAnimDuration, Z, A = this.config.showVolumeChart, V = k.shadow, K = k.shadowOnCanvasFill, k = k.canBGColor;
                Z = {
            ...
            _createAxes: function () {
                var b = this.components, a, g = J.register("component", ["axis", "cartesian"]), d = this.config.showVolumeChart, f, c;
                b.yAxis = [];
                b.xAxis = [];
                b.yAxis[0] = f = new g;
                b.yAxis[1] = a = new g;
            ...
            _feedAxesRawData: function () {
                var a = this.components, c = a.colorManager, n = this.jsonData, d = n.chart, l, L, h = this.is3d, q = h ? w.chart3D : w.chart2D, k = J.register("component", ["axis", "cartesian"]), t = this.config.showVolumeChart;
                l = {
            ...
            _setCategories: function () {
                var b = this.jsonData, a = this.components.xAxis, b = b.categories && b.categories[0].category || [], g = [], d, f;
            ...
            _setAxisLimits: function () {
                var b = this.components, a = b.dataset, g = b.yAxis, b = b.xAxis, d, f = a.length, c, h = -Infinity, q = Infinity, k = -Infinity, t = Infinity, O = Infinity, x = -Infinity, p, G = 0, u = {};
    ...
    J.register("module", ["private", "modules.renderer.js-kagi",
        function () {
            var a = this.hcLib, c = a.chartAPI, E = Math, e = E.min, ba = E.max, W = a.pluck, S = a.pluckNumber, I = a.toPrecision, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
            c("kagi", {
                    standaloneInit: !0,
                    ...
                    hasLegend: !1,
                    _postSpaceManagement: function () {
                        var a = this.config, c = this.components, E = c.xAxis && c.xAxis[0], I = c.yAxis && c.yAxis[0], r = c.canvas.config, D = r.canvasBorderWidth, v = r.canvasPadding || 15, A = r.canvasPaddingTop,
                            r = r.canvasPaddingBottom, F = this.jsonData.chart, l = (c = c.dataset[0].config) && c.shiftCount, C = S(E.getAxisConfig("axisMinValue"), 0), H = S(E.getAxisConfig("axisMaxValue"), l - 1), Q = this.config.canvasWidth;
                    ...
                    _setPosition: function () {
                        ...
                        a = this.components;
                        E = this.jsonData;
                        var A = a.dataset[0], F = E.data || A && A[0] && A[0].data, l = (A = A.components.data) && A.length, C = a.yAxis[0], H = 0, Q = H, n = [];
                    ...
                    _setAxisLimits: function () {
                        var a = this.components, c = a.dataset, E = a.yAxis, a = a.xAxis, I, r = c.length, D, v = -Infinity, A = Infinity, F = Infinity, l = -Infinity, C, H = {}, Q = [], n = function (b) {
                            v = ba(v, b.max);
                            A = e(A, b.min);
                            l =
    ...
    J.register("module", ["private", "modules.renderer.js-boxandwhisker2d", function () {
        var a = this.hcLib, c = a.chartAPI, E = a.pluck, e = a.parseUnsafeString, ba = a.BLANKSTRING, W = a.BLANKSTRING, S = a.preDefStr.sStr, I = a.componentDispose, B = a.HUNDREDSTRING, X = a.setAttribDefs, M = a.attrTypeNum, R = !a.CREDIT_REGEX.test(this.window.location.hostname), r = Math, D = r.round, v = r.abs, A = r.ceil, F = r.floor, l = r.sqrt, C = r.pow;
        ...
        c("boxandwhisker2d", {
            ...
            _createDatasets: function () {
                var a = this.components, c = a.xAxis[0], n = this.jsonData, b = n.dataset, z = b && b.length, f, l, r, m = this.defaultDatasetType, v = this.applicableDSList, A = this.components.legend;
    ...
    J.register("module", ["private", "modules.renderer.js-heatmap", function () {
        var a = this.hcLib, c = a.chartAPI,
            E = a.pluckFontSize, e = a.pluck, ba = a.pluckNumber, W = a.preDefStr, S = W.defaultFontStr, I = W.divLineAlpha3DStr, B = W.divLineAlphaStr, X = W.altVGridColorStr, M = W.altVGridAlphaStr, R = W.altHGridColorStr, r = W.altHGridAlphaStr, D = W.colors.c000000, W = !a.CREDIT_REGEX.test(this.window.location.hostname);
        c("heatmap", {
            ...
            _postSpaceManagement: function () {
                var a = this.config, c = a.placeAxisLabelsOnTop, e = this.components, l = e.xAxis && e.xAxis[0], r = e.yAxis && e.yAxis[0], H = e.legend, Q = a.xDepth, e = e.canvas.config.canvasBorderWidth;
            ...
            _setCategories: function () {
                var a = this.components, c = this.jsonData,
                    r = a.xAxis, a = a.yAxis, l = c.dataset && c.dataset[0].data && c.dataset[0].data.length, C, H, Q, n, b, z = [], f = [], K;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorbar2d", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.colors, e = E.FFFFFF, ba = E.AAAAAA, W = c.configStr, S = c.animationObjStr, I = c.columnStr, B = c.shadowStr, X = c.errorBarStr, M = c.errorShadowStr, R = c.miterStr, r = c.visibleStr, D = c.visiblilityStr,
            v = c.ROUND, A = c.PERCENTAGESTRING, F = c.pStr, l = c.sStr, C = a.BLANKSTRING, H = a.parseTooltext, Q = a.pluck, n = a.getValidValue, b = a.pluckNumber, z = a.getFirstValue, f = a.toRaphaelColor, K = a.COMMASPACE, V = c.showHoverEffectStr, m = c.setRolloverAttrStr, Z = c.setRolloutAttrStr, ga = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")", c = a.TOUCH_THRESHOLD_PIXELS, E = a.CLICK_THRESHOLD_PIXELS, L = Math, w = L.round, U = L.min, g = L.max, y = L.abs, P = a.hasTouch ? c : E, ka = a.getFirstColor, d = a.getFirstAlpha, N = a.graphics.getLightColor, T = a.graphics.convertColor, h = a.HUNDREDSTRING,
            q = a.plotEventHandler;
        J.register("component", ["dataset", "ErrorBar2D", {
            configure: function () {
                var k = this.chart, d = this.config, q = this.JSONData, x = q.data, p = k.config.categories, c = U(p && p.length, x && x.length), u = k.jsonData.chart, da = k.components.colorManager, m, y = da.getPlotColor(this.index || this.positionIndex), aa = b(q.dashed, u.plotborderdashed), L = b(u.useplotgradientcolor, 1), r = a.parseUnsafeString, T = r(u.yaxisname), P = r(u.xaxisname), Z = r(Q(u.tooltipsepchar, K)), v = b(u.seriesnameintooltip, 1), V = a.parseTooltext, H, ga, D, E, ka,
                    B, M, I, W, S, X, R, ba, J, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za, Ga, Ma = a.getDashStyle, ra = this.components.data, Ba = k.components.numberFormatter, Ua = k.isBar, Ja = k.is3D;
                ea = k.isStacked;
                var ja, xb, eb;
                m = {};
                ...
                var k = this.chart, t = this.config, q = this.JSONData, h = q.data, p = k.config.categories, p = U(p && p.length, h && h.length), c = k.jsonData.chart, k = a.parseUnsafeString, f,
                    w, e, y = this.components.data, m = k(c.yaxisname), l = k(c.xaxisname), L, r = b(c.seriesnameintooltip, 1), N, P = k(Q(c.tooltipsepchar, K)), Z, v, A, V, ga, E, D, B = -Infinity, F = Infinity, M, I, W, S, X, R = function (k) {
                ...
                var k = this, d = k.JSONData, q = k.chart.jsonData.chart, h = k.config, p = k.groupManager, c = k.index, g = k.chart.config.categories, n = d.data, w, e, z, l, L = k.visible, r = k.chart, N = r.components.paper, T = r.components.xAxis[0], v = r.components.yAxis[0];
                w = r.graphics.columnGroup;
                var A, H, K = a.parseUnsafeString, D = a.getValidValue, E = a.Raphael, F = h.showTooltip, ka = T.getAxisPosition(0), M = T.getAxisPosition(1), X = h.groupMaxWidth = M - ka, ba =
                        h.definedGroupPadding, J = h.plotSpacePercent / 200, Fa = p.getDataSetPosition(k), ka = p.manageClip, wa = h.maxColWidth, oa = r.get(W, S), M = oa.animType, qa = oa.animObj, la = oa.dummyObj, oa = oa.duration, X = (1 - .01 * ba) * X || U(X * (1 - 2 * J), 1 * wa), X = b(Fa.columnWidth, X / 1), ia, ba = Fa.xPosOffset || 0, Fa = Fa.height, ea, sa, J = k.components.data, fa, ha, ca, Aa, ya, wa = v.getLimit(), Y = wa.min, wa = 0 < wa.max && 0 > Y, Y = v.getAxisBase(), ua = v.yBasePos = v.getAxisPosition(Y), xa = 0, za = h.showShadow, Ga = h.plotBorderThickness, h = h.plotRadius, Ma = k.graphics.container, ra = k.graphics.dataLabelContainer,
                    Ba = k.graphics.shadowContainer, Ua = k.graphics.errorGroupContainer, Ja = k.graphics.errorShadowContainer, ja, xb = !0, eb = !1, Qb = !1, Db = (k.components.removeDataArr || []).length, Kb = k.components.pool || [], pb = r.config.plothovereffect, hb, Eb = function () {
                ...
                var k = this.graphics && this.graphics.container, d = this.graphics && this.graphics.dataLabelContainer, a = this.graphics && this.graphics.shadowContainer, b = this.graphics && this.graphics.errorGroupContainer, q = this.graphics && this.graphics.errorShadowContainer, h = this.chart.is3D, c = this.components.data, f = this.chart.config.categories, g = this.yAxis, n = this.chart, f = U(this.JSONData.data && this.JSONData.data.length, f && f.length);
                n._chartAnimation();
                this.visible = !0;
                ...
                var a = this.chart, f = a.components.xAxis[0].getCategoryLen(),
                    g = a.graphics.columnGroup, n = a.components.paper, e = a.components.yAxis[0], z = this.components.data, m = this.groupManager.getDataSetPosition(this).height, l = a.get(W, S), L = l.animType, r = l.animObj, N = l.dummyObj, l = l.duration, T = d.errorBarThickness, Z = d.errorBarWidthPercent, A = d.errorBarColor, V = d.showTooltip, d = d.shadowOpacity, H = this.graphics.errorGroupContainer, K = this.graphics.errorShadowContainer, D, E, Q, B, F, ka, I, R, ba, J, ia, ea, sa, fa, ha, ca = 5 < T ? T / 2 : 2.5, Aa;
                ...
                var p = this.chart, f = this.components.data[d], c = f.graphics.element, g = f.errorBarHovered, n = a.toolTip, w = b.originalEvent, e = p.components.paper.canvas.style, z = f.config.setLink;
                if (c)switch (k) {
                    case "mouseover":
                ...
                var a = this.chart, b = a.components.canvas.config, a = a.components.xAxis[0].getValue(k - a.config.canvasLeft - Math.max(b.canvasPaddingLeft, b.canvasPadding)), b = Math.round(a);
                ...
                var d = this.components, a = d.removeDataArr,
                    b = d.pool || (d.pool = {
                            ...
                            hotElement: [],
                            label: []
                        }), q = a.length, h, f = this.maxminFlag, c, g, n;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorline", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.colors.AAAAAA, e = c.configStr, ba = c.animationObjStr, W = c.errorBarStr, S = c.errorShadowStr, I = c.ROUND, B = c.PERCENTAGESTRING, c = c.line, X = a.BLANKSTRING, M = a.parseTooltext, R = a.pluck, r = a.getValidValue, D = a.pluckNumber, v = a.getFirstValue, A = a.COMMASPACE, F = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")",
            l = a.TOUCH_THRESHOLD_PIXELS, C = a.CLICK_THRESHOLD_PIXELS, H = Math, Q = H.round, n = H.min, b = H.max, z = H.abs, f = a.hasTouch ? l : C, K = a.getFirstColor, V = a.getFirstAlpha, m = a.graphics.convertColor, Z = a.HUNDREDSTRING;
        J.register("component", ["dataset", "ErrorLine", {
            type: c,
            ErrorValueConfigure: function () {
                var f = this.chart, c = this.config, w = f.config, e = c.parentYAxis, g = this.JSONData, z = g.data, l = f.jsonData.chart, H = f.components.xAxis[0].getCategoryLen(), d = a.parseUnsafeString, N, T, h, q = this.components.data, f = f.components.numberFormatter,
                    k, t, O, x, p, G, u, da;
                da = c.linethickness;
                var ma = -Infinity, La = Infinity, aa, C = d(l.yaxisname), F = d(l.xaxisname), ta, I = R(l.tooltipsepchar, A), W, Qa, Ea, S, ba = D(l.seriesnameintooltip, 1), J = function (d) {
            ...
            show: function () {
                var a = this.chart, b = this.yAxis, f = this.graphics && this.graphics.container, c = this.graphics && this.graphics.dataLabelContainer, g = this.graphics && this.graphics.errorGroupContainer, n = this.graphics && this.graphics.errorShadowContainer;
                a._chartAnimation();
                f.lineGroup.show();
                f.anchorGroup.show();
            ...
            drawErrorValue: function () {
                var a = this.config, b = this.chart, c = b.graphics.datasetGroup, n = b.components, g = n.xAxis[0].getCategoryLen(), l, m, r = this.visible, n = n.paper, d = this.yAxis, N = this.components.data, T = b.get(e, ba), h = T.animType, q = T.animObj, k = T.dummyObj, T = T.duration, t = a.errorBarThickness, O = a.errorBarWidth,
                    x = a.errorBarColor, b = b.config.showtooltip, a = a.shadowOpacity, p = this.graphics.container.lineGroup, G = this.graphics.errorGroupContainer, u = this.graphics.errorShadowContainer, da, v, Z, aa, A, H, V, K, C, D, E = 5 < t ? t / 2 : 2.5, B, M;
            ...
            manageSpace: function () {
                var a = .5 * this.config.errorBarWidth, f = this.chart, c = f.config.dataLabelStyle, n = (this.components || {}).data || [], g = n[0], n = n[n.length - 1], e, z;
                e = {};
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-errorscatter", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.colors.AAAAAA, e = c.configStr, ba = c.animationObjStr, W = c.errorBarStr, S = c.errorShadowStr, I = c.ROUND, B = c.PERCENTAGESTRING, X = a.BLANKSTRING, M = a.BLANKSTRING, R = a.parseTooltext, r = a.pluck, D = a.getValidValue, v = a.pluckNumber, A = a.COMMASPACE, F = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")", c = a.TOUCH_THRESHOLD_PIXELS, l = a.CLICK_THRESHOLD_PIXELS,
            C = Math, H = C.round, Q = C.min, n = C.max, b = C.abs, z = a.hasTouch ? c : l, f = a.getFirstColor, K = a.getFirstAlpha, V = a.graphics.convertColor, m = a.HUNDREDSTRING;
        J.register("component", ["dataset", "ErrorScatter", {
            ErrorValueConfigure: function () {
                var b = this.chart, c = b.components, e = this.config, w = this.JSONData, z = b.config.categories, g = b.jsonData.chart, l = w.data, P = c.xAxis[0].getCategoryLen(), P = l && l.length || P, C = a.parseUnsafeString, d, N, T, h = this.components.data, q = c.numberFormatter, k, t, O, x, p, G, u, da, ma, La, aa = r(g.tooltipsepchar, A), F = C(g.yaxisname),
                    M = C(g.xaxisname), ta = e.parentYAxis, I, W, Qa, Ea, S, ba, J, pa, Na, Ra, Va, Da, Ia, va, Fa, wa, oa, qa, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za = -Infinity, Ga = Infinity, Ma = Infinity, ra = -Infinity, Ba = function (k, b) {
                        var t;
                ...
                var c = this.chart, f = c.components, n = this.parentContainer, w = this.config, m = this.JSONData.data, m = m && m.length, g, l = this.visible, r = f.paper, f = f.xAxis[0], A = this.yAxis, d = this.components.data, N, T, h, q, k = w.showTooltip, t = w.shadowOpacity,
                    O = c.get(e, ba), c = O.animType, x = O.animObj, p = O.dummyObj, O = O.duration, G = this.graphics.container.lineGroup, u = this.graphics.errorGroupContainer, da = this.graphics.errorShadowContainer, ma, V, aa, K, C, D, E, Q, B, Ea, R, X, J, pa, Na = [], Ra;
                ...
                var a = this.chart, b = this.yAxis, c = this.graphics && this.graphics.errorGroupContainer, f = this.graphics && this.graphics.errorShadowContainer;
                a._chartAnimation();
                this.visible = !0;
                this._conatinerHidden = !1;
                c && c.show();
                ...
                var a = this.components,
                    b = a.removeDataArr, c = a.pool || (a.pool = {
                            element: [],
                            hotElement: [],
                            label: []
        ...
        ["private", "modules.renderer.js-dataset-multiaxisline", function () {
            ...
            J.register("component", ["dataset", "multiaxisline", {
                type: "multiaxisline", pIndex: 2, customConfigFn: "_createDatasets", configure: function () {
                    var W = this.chart, S = this.JSONData, I = this.config, B = W.config, X = W.components, M = W.jsonData, R = M.chart, r = M.axis[this.axisIndex], D = W.singleseries, M = J.get("component", ["dataset", E]).prototype;
                ...
                legendInteractivity: function (a, c) {
                    var e = a.chart, E = e.components.dataset, X = this.config, M = a.visible, R = c.config, r = c.graphics, D = X.itemHiddenStyle.color, X = X.itemStyle.color, v = R.fillColor, R = R.strokeColor, A = a.axisIndex, F = !0, l, e = e.config.axesArr.checkBox;
                    M ? a.hide() : a.show();
                    if (M) {
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-multilevelpie", function () {
        var a = this.hcLib, c = a.graphics.convertColor, E = a.plotEventHandler, e = a.preDefStr, ba = e.colors, W = ba.FFFFFF, S = ba.c000000, I = e.configStr, B = e.animationObjStr, X = a.ZEROSTRING, M = a.BLANKSTRING, R = a.BLANKSTRING,
            r = a.parseTooltext, D = a.pluck, v = a.getValidValue, A = a.pluckNumber, F = a.getFirstValue, l = a.parseUnsafeString, C = a.getDashStyle, H = a.toRaphaelColor, Q = a.COMMASPACE, n = a.schedular, e = Math, b = e.sin, z = e.cos, f = e.PI, K = e.round, V = e.min, m = e.max;
        J.register("component", ["dataset", "multiLevelPie", {
            init: function (a) {
                ...
                var a, b, n = this, e = n.chart, z = e.config, g = n.conf || (n.conf = {}), m = g.dataLabelOptions ||
                    (g.dataLabelOptions = {}), l = g.piePlotOptions, r = e.config.style, d = n.JSONData, e = e.jsonData.chart;
                ...
                var g, z, V, H = a.length, d = this, N = f.components.data, T = d.chart.components, h = d.conf, q = h.borderWidth, k = h.borderColor, t = T.numberFormatter, T = T.colorManager,
                ...
                var f, e, m, l = this, g = l.conf || {}, r = l.chart, v = r.getJobList(), C = r.config, d = r.graphics, N = l.components, T = N.data.length, h = C.dataLabelStyle;
                f = g.showShadow;
                var q = r.components.paper, k = C.textDirection, t = C.tooltip || {};
                e = t && !1 !== t.enabled;
                var T = C.canvasWidth, O = C.canvasHeight, t = A(g.originX, C.canvasLeft + .5 * T), C = A(g.originY, C.canvasTop + .5 * O), x, p, G, u, da, ma, K = d.datasetGroup.trackTooltip(!0), aa = r.get(I,
                    B), D = aa.duration || 0, Q = aa.dummyObj, F = aa.animObj, aa = aa.animType, M, W, Qa, Ea = d.datalabels || (d.datalabels = q.group("datalabels").insertAfter(K)), X = g.events || {}, J = function (d) {
                    var k = X.mouseOver;
                ...
                var g = f.dataLabelStyle, n = c.components.paper,
                    f = (f = f.tooltip || {}, !1 !== f.enabled), m, z, d, l, r = (this.conf || {}).events || {}, h = function (d) {
                        var k = r.mouseOver;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragnode", function () {
        var a = this.hcLib, c = "VML" === a.Raphael.type, E = a.preDefStr, e = E.configStr, ba = E.animationObjStr, W = a.ZEROSTRING,
            S = E.POSITION_TOP, I = E.POSITION_BOTTOM, B = E.UNDERSCORE, X = a.BLANKSTRING, M = a.BLANKSTRING, R = a.parseTooltext, r = a.pluck, D = a.getValidValue, v = a.pluckNumber, A = a.getFirstValue, F = a.parseUnsafeString, l = a.extend2, C = a.toRaphaelColor, H = a.schedular, Q = a.getTouchEvent, n = a.BGRATIOSTRING, E = Math, b = E.min, z = E.max, f = a.hasTouch, K = a.getFirstColor, V = a.getFirstAlpha, m = a.graphics.getDarkColor, Z = a.graphics.getLightColor, ga = a.graphics.convertColor, L = a.graphics.mapSymbolName, w = a.COMMASTRING, U = a.HUNDREDSTRING, g = a.getMouseCoordinate,
        ...
        J.register("component", ["dataset", "Dragnode", {
            type: "dragnode", configure: function () {
                var d = this.index, a = this.chart, b = this.JSONData, h = a.jsonData.chart, q = (b.data || []).length, k = this.config, a = a.components.colorManager, t, c, f, p, g, u;
                ...
                var c = this.JSONData,
                    h = c.data, q = a ? a : h[d], k = this.components.data, h = this.config, k = k[d] = k[d] || (k[d] = {}), t = k.config = k.config || (k.config = {}), f = h.id, x = h.yMin || Infinity, p = h.yMax || -Infinity, g = h.xMax || -Infinity, u = h.xMin || Infinity, e, n, m = h.use3DLighting, w = h.datasetPlotBorderThickness, y = h.datasetPlotBorderColor, A = h.datasetPlotBorderAlpha, C = this.chart.jsonData.chart, V = h.color, H = h.alpha, E = h.datasetAllowDrag, U = this.chart.components.numberFormatter;
                ...
                var c = d.setTooltext, q = d.formatedVal, k = a.seriesname, t = d.label, f = d.xValue, x = d.pointLabel, p = a.tooltipSepChar;
                ...
                var c = this.chart, h = this.config, q = (this.components.data[a] || {}).config, k = c.components.numberFormatter, c = c.jsonData.chart, t = h.yMin || Infinity, f = h.yMax || -Infinity, x = h.xMax || -Infinity, p = h.xMin || Infinity;
                ...
                var d = this, b = d.components, c = d.graphics,
                    f = d.chart, q = f.getJobList(), k = f.linkedItems.smartLabel, b = b.data, t = d.components.removeDataArr || [], g = t.length, x = f.components.paper, p, e = f.config.dataLabelStyle, u = {
                ...
                return function (c) {
                    var f = this.data("drag-options"), q = f.chart, f = (f = f.dataObj.config.dragStart) && Object.keys(f).length, k = this.data("hoverAttr");
                    f || (b && a.graphics.element.attr(k), y.call(this, q, c, "DataPlotRollOver"))
                }
            }, rolloutResponseSetter: function (a,
                                                b) {
                return function (c) {
                    var f = this.data("drag-options"), q = f.chart, f = (f = f.dataObj.config.dragStart) && Object.keys(f).length, k = this.data("unHoverAttr");
            ...
            _drawNode: function (a) {
                var b = this.chart, c = this.index, f = b.components, q = this.groupManager, k = q.nodes, t = f.paper, g = this.xAxis = f.xAxis[0], x = this.yAxis = f.yAxis[0], f = this.components.data[a], p = f.config, G = this.config, u = b.get(e, ba) || {}, n = u.duration, m = u.dummyObj, l = u.animObj, u = f.graphics || (f.graphics = {}), z = p.symbol, w, y, A, V, H, K, E, D, U = G.colorObj.lineColor, L = G.datasetPlotBorderThickness, Q, Z, F;
                V = this.graphics;
                E = b.graphics.datasetGroup;
                var W = V.group, R = f.config.rollOverProperties, ka, S, ga = this.rolloverResponseSetter,
                    J = this.rolloutResponseSetter, oa = this.dragUp, qa = this.dragMove, la = this.dragStart, ia, ea = p.shapeType, sa = p.link ? "pointer" : p.allowDrag ? "move" : M, fa = this.components.pool || {}, ha;
                K = u.graphic;
                ...
                var b = this.chart, c = this.index, f = b.components.paper, q = this.components.data, k = q.length, t, g, x = this.graphics.group, p = b.config.dataLabelStyle, e = b.get("config", "animationObj"), u = e.dummyObj, n = e.animObj, z = e.duration, m = this.components.pool || {}, l, w, y = b.config, v, K, A, e = e.animType, C, V, H = this.rolloverResponseSetter, E = this.rolloutResponseSetter, U = this.dragUp,
                ...
                var g = this.data("drag-options"), h = g.dataObj, q = h.graphics.element, k = q.getBBox(), t = h.config, e = g.dataset, x = e.groupManager, p = x.graphics, n = p.waitElement, u = g.dataset.config, g = u.viewMode;
                f && Q(a);
                var l = b.components.paper, m = e.graphics.group, z = t.dragStart || (t.dragStart = {}), r = h.graphics.cloneGraphic, y = e.graphics.cloneGraphicGroup, v = h.graphics.cloneText,
                    K = h.graphics.image, V = h.graphics.cloneImage, H = h.graphics.label, E = {
                        circle: "circ",
                        rectangle: "rect",
                        polygon: "poly"
                    };
                ...
                var x = t.graphics.cloneText, t = t.config, p = t.dragStart, e = p.bBox.x + a, u = p.bBox.x2 +
                    a, n = p.bBox.y + b, l = p.bBox.y2 + b, z = k.dataset.groupManager.graphics, m = q.config.canvasLeft, r = q.config.canvasRight, w = q.config.canvasTop;
                ...
                var c = this.data("drag-options"), f = c.dataset, h = f.chart, q = f.components.data, k = c.dataObj, t = k.graphics.element, e = c.dataset.groupManager, x = t.data("fire_click_event"), c = k.config, p = h.config.canvasTop, n = h.config.canvasLeft, u = k.config.dragStart || {}, z = f.yAxis, m = k.graphics.cloneText, r = f.groupManager.graphics, w = h.components.xAxis[0], v = {}, K,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-connector", function () {
        var a = this.hcLib, c = a.preDefStr.configStr, E = a.BLANKSTRING, e = a.BLANKSTRING, ba = a.parseTooltext, W = a.pluck, S = a.getValidValue, I = a.pluckNumber, B = a.parseUnsafeString, X = a.getDashStyle, M = a.toRaphaelColor, R = a.schedular, r = Math, D = r.sin, v = r.cos, A = r.abs, F = a.getFirstColor, l = a.HUNDREDSTRING, C = a.plotEventHandler, H = a.SHAPE_RECT, Q = function () {
            this.data("move", !1);
            clearTimeout(this._longpressactive);
            delete this._longpressactive
        };
        J.register("component",
            ["dataset", "Connector", {
                type: "connector", configure: function () {
                    var c = this.chart.jsonData.chart, b = this.config, e = this.components.data || (this.components.data = []), f = this.JSONData, r = f.connector, v = r && r.length, m = a.parseUnsafeString;
                    ...
                    var c = this.components.data, c = c[a] || (c[a] = c[a] = {}), f = this.config, e = this.chart, l = B(W(b.label, b.name)), m = W(b.alpha, f.conAlpha), r = e.linkedItems.smartLabel, v = "$fromLabel" + f.toolTipSepChar + "$toLabel",
                        m = {
                            FCcolor: {
                    ...
                    var c =
                        this, b = c.chart, e = c.config, f = b.graphics, l = c.groupManager.nodes, r = c.components.data, m, v, A = c.chart.components.paper, C = b.getJobList();
                    v = f.datasetGroup;
                    ...
                    var a = this, b = a.data(c), e = a.data("dataset"), f = e.groupManager, l = e.chart, r = e.config, m = b || {};
                    ...
                    if (!a.removed) {
                        var f = this.chart, r, v, m, A, C = f.components.paper, H = f.components.numberFormatter, w = a.graphics, E = f.get("config", "animationObj"), f = this.graphics.connectorGroup, g =
                            E.animObj, y = E.dummyObj, D = E.animType, E = E.duration, F = a.config;
                        v = F.toolText;
                        var d, Q, B = F.eventArgs || (F.eventArgs = {}), h = this.config, q = this.components.pool || {};
                        F.fromPointObj = b;
                        F.toPointObj = l;
                        d = b.config;
                        Q = l.config;
                    ...
                    var b = this, l = b.config, f = b.chart, r = f.components.paper, v = f.get("config", "animationObj"), m = b.graphics.connectorGroup, A = v.animObj, C = v.dummyObj, H = v.animType, w = v.duration, E, g, y, F, D = f.config.dataLabelStyle, d, Q, B, h, q, k, f = b.components.data, t = b.components.pool || {}, v = f.length, O = function (a) {
                        E = a.config;
                        y = E.toolText;
                        Q = a.graphics;
                        g = E.label;
                    ...
                    a = a.config;
                    var b = a.fromPointObj, c = a.toPointObj, f = a.fromX, e = a.fromY, l = a.toX, m = a.toY, r = ["M", f, e];
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragablelabels", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.configStr, e = c.animationObjStr, ba = c.visibleStr, W = a.BLANKSTRING, S = a.pluck, I = a.pluckNumber, B = a.parseUnsafeString, X = a.extend2, M = a.getDashStyle, R = a.regex.dropHash, r = a.HASHSTRING, D = a.hashify, v = a.schedular, A = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")", F = a.setLineHeight,
        ...
        J.register("component", ["dataset", "DragableLabels", {
            configure: function () {
                ...
                var e = this.JSONData, e = c ? c : e[a], b = this.components.data, l, f = this.chart.config.style.inCanvasStyle, v = f.fontSize;
                l = b[a];
                !l && (l = b[a] = {});
                !l.graphics &&
                (l.graphics = {});
                ...
                var c = this, l = c.components.data, n = c.chart, b = n.getJobList(), r = n.get(E, e), f = r.duration, A = r.animType, C = r.dummyObj,
                    r = r.animObj, m = n.components.paper, D = n.components.yAxis[0], B = n.components.xAxis[0], L = n.linkedItems.smartLabel, w = n.graphics.datalabelsGroup, U = n.graphics.trackerGroup, g = n.config.dataLabelStyle, y, P, R, d, N, T, h, q, k, t, O, x, p, G, u, da = l.length, ma = c.components.removeDataArr || [], La = ma.length, aa = c.components.pool || {}, S, X, w = c.graphics.dataLabelContainer = c.graphics.dataLabelContainer || m.group("datalabels", w);
                ...
                var a = this, c = a.components.data, e = a.chart, b = e.components.paper, l = a.groupManager, f = a.config, r = a.graphics.trackerContainer,
                ...
                var a = this, c = a.getBBox(), e = a.data("drag-options"), b = e.dataset, l = b.groupManager, f = b.components.data[e.index], b = f.graphics.element, r = f.dragStart = f.dragStart || (f.dragStart = {});
                e.ox = b.attr("x");
                e.oy = b.attr("y");
                e.bBox = c;
                ...
                var b = e.config, l = b.canvasLeft, f = b.canvasRight, r = b.canvasBottom, b = b.canvasTop, v = this.data("drag-options"), m = v.dataset, A = m.groupManager, m = m.components.data[v.index], E = m.graphics.element, F = m.dragStart, w = F.bBox, D = c[0];
                c = c[1];
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragcolumn", function () {
        var a = this, c = a.hcLib, E = c.pluck,
            e = c.pluckNumber, ba = c.parseUnsafeString, W = c.getValidValue, S = c.toRaphaelColor, I = c.hasSVG, B = Math, X = B.round, M = B.abs, R = c.plotEventHandler;
        J.register("component", ["dataset", "DragColumn", {
            configure: function () {
                ...
                var A = this.JSONData, F = this.chart.jsonData.chart, l = this.chart, C = this.config, H = l.config, B = H.useplotgradientcolor, n = H.useroundedges, b = l.components, z = b.paper,
                    f = z.canvas.style, K = b.numberFormatter, V = this.components.data[D], m = V.config, Z = V.graphics.element, J = m.finalTooltext, L = c.toolTip, w = v.originalEvent, U = I && "ns-resize" || "n-resize", g = v.originalEvent;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-dragarea", function () {
        var a = this, c = a.hcLib, E = "VML" === c.Raphael.type, e = c.BLANKSTRING, ba = c.parseUnsafeString, W = c.getValidValue, S = c.preDefStr.hiddenStr, I = c.pluck, B = c.pluckNumber, X = c.hasSVG, M = Math, R = M.round, r = M.min, D = M.max, v = c.plotEventHandler;
        J.register("component", ["dataset", "DragArea", {
            configure: function () {
                ...
                var c =
                    this.chart, l = a.graphics, l = l.image || l.element, v = a.config, D = v.anchorProps, B = v.hoverEffects, v = l && l.data("imgRef"), n = function (a) {
                    var b = a.length, c = e, f;
                    for (f = 0; f < b; f += 1)c += " " + a[f];
                    return c
                }, b = D.imageScale, z = c.components.paper, f = v.height * b * .01, K = v.width * b * .01, c = a._xPos;
                a = a._yPos;
                var V = B.imageHoverScale, m = v.width * V * .01, Z = v.height * V * .01, I = D.radius = D.isAnchorRadius ? D.radius : r(K, f) / 2, L = D.imagePadding, w = I - L - .5 * D.borderThickness, L = B.radius - L - .5 * B.anchorBorderThickness, I = D.symbol[1], D = z.polypath(I || 2, c, a, 0 < w ?
                    w : 0, D.startAngle, 0).attr({visibility: S}), w = n(D.attrs.path), b = {
                    x: c - v.width * b * .005,
                    y: a - v.height * b * .005,
                    width: K,
                    height: f,
                ...
                var C = this.JSONData, B = this.chart.jsonData.chart, Q = this.chart, n = Q.config,
                    b = Q.components, z = b.paper, f = c.toolTip, K = z.canvas.style, V = b.numberFormatter, m = this.components, Z = m.data[r], M = m.data.length, L = J.get("component", ["dataset", "DragArea"]), w = this.config, U = this.index;
                l = l.originalEvent;
                var g = X && "ns-resize" || "n-resize", y, P, S, d, N, T, h, q, k, t;
                y = Z && Z._yBasePos;
                var O = b.yAxis[0], x = n.canvasTop, p = n.canvasBottom, G, u, b = this.graphics.lineElement, da, ma, La;
                u = u ? p : y;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-selectscatter", function () {
        var a = this, c = a.hcLib, E = c.graphics.convertColor, e = c.preDefStr, ba = e.altHGridColorStr, W = e.altHGridAlphaStr, S = e.colors.FFFFFF, I = c.getValidValue, B = c.ZEROSTRING,
        ...
        J.register("component", ["dataset", "selectScatter", {
            configure: function () {
                var c = this.chart, e = c.config, F = c.jsonData.chart, c = c.components.colorManager, l = r(F.selectbordercolor, c.getColor("canvasBorderColor")), C = D(F.selectborderalpha, c.getColor("canvasBorderAlpha"));
                ...
                X(c, {
                    selectionStart: function (c) {
                        ...
                        var l = M(e, c.originalEvent), r = c.chart.components.xAxis[0], v = c.chart.components.yAxis[0], l = R({
                            selectionLeft: c.selectionLeft,
                            selectionTop: c.selectionTop,
                            selectionWidth: c.selectionWidth,
                            selectionHeight: c.selectionHeight,
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-candlestick", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.line, e = c.volume, ba = c.bar, W = a.BLANKSTRING, S = a.getValidValue, I = a.getFirstValue, B = a.getFirstColor, X = c.setRolloverAttrStr, M = c.setRolloutAttrStr, R = a.ZEROSTRING, r = a.parseUnsafeString, D = c.column, v = a.getDashStyle, A = c.animationObjStr, F = c.columnStr, l = c.shadowStr, C =
            a.toRaphaelColor, H = c.miterStr, Q = a.schedular, n = c.showHoverEffectStr, b = c.ROUND, z = c.visibleStr, f = c.errorBarStr, K = c.errorHotStr, V = c.UNDERSCORE, m = a.parseTooltext, Z = c.colors, ga = a.extend2, L = c.configStr, w = Z.B90000, U = Z.FFFFFF, g = a.pluck, y = a.pluckNumber, c = Math, P = c.round, ka = c.min, d = c.max, N = c.abs, T = a.plotEventHandler;
            ...
            type: "Candlestick", configure: function () {
                if (this.plotType === e) this._configureVolume(); else {
                    var b = this.config, c = this.chart, k = c.components, f = this.JSONData,
                        l = f.data || [], x = c.jsonData.chart, p = l.length, G = b.plotPriceAs = S(x.plotpriceas, W).toLowerCase(), u = k.numberFormatter, n = k.colorManager, m, z, aa, A, k = b.bearBorderColor = B(g(x.bearbordercolor, w)), C = b.bearFillColor = B(g(x.bearfillcolor, w)), K = b.bullBorderColor = B(g(x.bullbordercolor, n.getColor("canvasBorderColor"))), F = b.bullFillColor = B(g(x.bullfillcolor, U)), L = b.linethickness = b.plotBorderThickness = y(x.plotlinethickness, G == E || G == ba ? 2 : 1), H = b.plotLineDashLen = y(x.plotlinedashlen, 5), P = b.plotLineDashGap = y(x.plotlinedashgap,
                        4), Z = !!y(x.drawanchors, 1), I = y(x.anchorstartangle, 90), Q = y(x.anchorradius, this.anchorRadius, 3), T = B(g(x.anchorbordercolor, K)), M = y(x.anchorborderthickness, this.anchorBorderThickness, 1), n = B(g(x.anchorbgcolor, n.getColor("anchorBgColor"))), X = g(x.anchoralpha, R), J = g(x.anchorbgalpha, X), ga, Ia, va, Fa, wa, oa, qa, la, ia, ea, sa, fa, ha, ca = !1, Aa = -Infinity, ya = Infinity, Y = -Infinity, ua = Infinity, xa = a.graphics.mapSymbolName;
                    b.parentYAxis = 0;
                ...
                E ? 1 : 0, f = this.JSONData.data[a], e = this.components.data[a].config, k = k.components.xAxis[0].getLabel(e.x).label;
                a = e.open;
                var G = e.close, u = this.yAxis, l = e.high, n = e.low, e = e.volume, w = void 0 !== e ? f.volumetooltext : void 0;
                ...
                var b = this.config, c = this.chart, k = this.JSONData, f = k.data || [], e = c.jsonData.chart, x = f.length, p = c.components.colorManager, G, u, l, n, m, z, E = b.bearBorderColor = B(g(e.bearbordercolor, w)), A = b.bearFillColor = B(g(e.bearfillcolor, w)), p = b.bullBorderColor = B(g(e.bullbordercolor, p.getColor("canvasBorderColor"))), C = b.bullFillColor = B(g(e.bullfillcolor, U)), K = y(e.showvplotborder,
                    1) ? y(e.vplotborderthickness, 1) : 0, V = b.plotLineDashLen = y(e.plotlinedashlen, 5), F = b.plotLineDashGap = y(e.plotlinedashgap, 4), L, H = this.yAxis, P = -Infinity, Z = Infinity, Q = -Infinity, T = Infinity;
                ...
                var b = this, c = b.JSONData, k = b.chart, d = k.getJobList(), f = b.chart.jsonData.chart, e = b.config, p = b.index, G = c.data, u = G && G.length, m, r, w = b.visible, z = k.components.paper, v = k.components.xAxis[0], E = b.yAxis, B, K, U = k.graphics, P = a.parseUnsafeString, Z = a.getValidValue,
                    T = a.Raphael, I, S = e.showTooltip, R = k.get(L, A), ba = R.duration, ga = R.dummyObj, Va = R.animObj, Da = v.getPVR(), Ia = e.plotSpacePercent, va = e.maxColWidth, Da = (1 - .01 * e.definedGroupPadding) * Da || ka(Da * (1 - 2 * Ia), 1 * va), Ia = Da / 2, Da = Da / 1, va = ka(Da - 1, 0), Ia = 0 * Da - Ia + va / 2, Fa, wa = b.components.data, oa, qa, la, ia, va = E.getAxisBase(), ea = E.yBasePos = E.getAxisPosition(va), sa = e.plotBorderThickness, fa = e.plotRadius || 0, ha = b.graphics.container, ca = b.graphics.shadowContainer, Aa, ya, Y, ua = !k.config.plotAnimDone, xa = b.components.removeDataArr || [], za =
                ...
                var k = this.chart, c = k.components.canvas.config, d = k.components.xAxis[0], f = this.components.data, e, g = f.length;
                e = this.config;
                ...
                var c = this.chart.config, d = c.plotborderthickness, f = c.showplotborder, e = this.components.data, g = e[a], u = c.viewPortConfig, l = u.x, n = u.scaleX, u = c.dragTolerance || 0;
                ...
                for (d in a) {
                    c = b[d] || (b[d] = []);
                    f = a[d];
                    if (f instanceof Array)for (e = 0, g = f.length; e < g; e++)this._removeDataVisuals(f[e]); else f.hide && "function" === typeof f.hide && f.hide();
                    c.push(a[d])
                }
            }, _drawCandlestickBar: function () {
                var a = this.chart, c = a.components, d, f = this.config, e = this.components.data, g = e.length, p = c.xAxis[0], G = this.yAxis, u = a.graphics, c = c.paper, l = f.numColumns || 1, n = f.columnPosition || 0, m = p.getPVR(), r = f.groupPadding, w = f.maxColWidth, m = (1 - .01 * f.plotspacepercent) * m || ka(m * (1 - 2 * r), w * l), l = m / l * n - m / 2, u = u.datasetGroup, v, E, B, D, K, n = a.get(L, A) || {}, m = n.duration, r = n.dummyObj, w = n.animObj, V = this.graphics.container, U = this.components.pool || {};
                d = this.visible;
                var H,
                ...
                var e = this.chart, g = e.components.paper, x = e.components.yAxis[0],
                    p = this.components.data, G, u = a.errorBarWidthPercent, l, n = e.graphics, m = n.datasetGroup, a = a.showTooltip, r = this.graphics.errorGroupContainer, w = this.graphics.errorTrackerContainer, z = n.trackerGroup, v, y, E, B, C, D, V, e = e.get(L, A), n = e.duration, F = e.dummyObj, U = e.animObj, H, I, Z, Q;
                v = this.drawn;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-trendset", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.configStr, e = c.animationObjStr, ba = c.miterStr, W = c.ROUND,
            S = c.line, I = a.pluck, B = a.getValidValue, X = a.pluckNumber, M = a.getFirstValue, R = a.getDashStyle, r = a.toRaphaelColor, c = Math, D = c.min, v = c.max, A = a.getFirstColor, F = a.HUNDREDSTRING;
        J.register("component", ["dataset", "Trendset", {
            configure: function () {
                var a = this.chart, c = a.jsonData.chart, e = this.JSONData, r = this.index, n = e.data || e.set || [], b = this.config, z, f = this.components.data, E, V = -Infinity, m = Infinity, F, M = -Infinity, L = Infinity, w = a.components.numberFormatter, r = A(I(e.color, c.trendsetcolor, "666666"));
                ...
                var a = this.chart, c = a.components, v = this.config, B = c.canvas.config.clip, n = this.components.data.length, b, z = c.paper, c = c.xAxis[0], f = this.yAxis, A, D, m = a.graphics, F = a.get(E, e), a = F.duration, I = F.dummyObj, L = F.animObj, F = F.animType, w = this.components.data, U, g = v.lineThickness, y = this.graphics.container, P = m.datasetGroup, m = v.shadow, M = function () {
                    ...
                    N = v.lineDashStyle, v = {
                        color: v.lineColor,
                        alpha: v.lineAlpha
                    }, T = !1, h = this.graphics.lineElement, q = this.visible;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-boxandwhisker2d",
        function () {
            var a = this.hcLib, c = a.preDefStr, E = c.colors.c000000, e = c.configStr, ba = c.animationObjStr, W = c.showHoverEffectStr, S = c.shadowStr, I = c.dataLabelStr, B = c.visibleStr, X = c.ROUND, M = a.ZEROSTRING, R = c.pStr, r = c.sStr, D = c.POSITION_START, v = c.POSITION_TOP, A = c.POSITION_END, F = c.POSITION_BOTTOM, l = c.PLOTFILLCOLOR_STR, C = c.UNDERSCORE, H = c.line, Q = a.BLANKSTRING, n = a.BLANKSTRING, b = a.pluck, z = a.getValidValue, f = a.pluckNumber, K = a.getFirstValue, V = a.extend2, m = a.toRaphaelColor, Z = function (a) {
                    return void 0 !== a && null !== a
                }, ga = a.parseConfiguration,
                c = Math, L = c.round, w = c.min, U = c.max, g = a.getFirstColor, y = a.getFirstAlpha, P = a.graphics.getLightColor, ka = a.graphics.convertColor, d = a.POSITION_LEFT, N = a.COMMASTRING, T = a.HUNDREDSTRING, h = a.plotEventHandler;
            J.register("component", ["dataset", "boxandwhisker2d", {
                type: "boxandwhisker2d", configure: function () {
                    var c = this.chart, d = this.config, e = this.JSONData, h = e.data, x = c.config.categories, p = c.singleseries, G = c.config, u = w(x && x.length, h && h.length), l = c.jsonData.chart, v = c.components.colorManager, E = this.index || this.positionIndex,
                        aa, A = d.plotColor = v.getPlotColor(E), B = f(e.dashed, l.plotborderdashed), D = f(l.useplotgradientcolor, 1), C, K = a.parseUnsafeString, V = K(l.yaxisname), L = K(l.xaxisname), F = K(b(l.tooltipsepchar, ": ")), I = a.parseTooltext, H, Z, M, Q, W, S, X, J, ba, wa, oa, qa, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za, Ga, Ma, ra, Ba, Ua, Ja, ja, xb, eb, Qb, Db, Kb, pb, hb, Eb, Fb, Lb, ib = a.getDashStyle, qb = this.components.data, Ka = c.components.numberFormatter, Xb, Mb, $a, Pb, yb, nb, Sa, Wa = 0, ob = 0, Jb = a.BoxAndWhiskerStatisticalCalc, cb, Gb, jb, kb, zb, rb, Oa, fb, tb, Pa, sb, ab, na, Yb,
                    ...
                    var c = this.chart, f = c.jsonData.dataset, e = f && f.length, g = this.components, h, l, f = c.components.legend, m = {}, g = g.dataset || (g.dataset = []), e = e * (a + 1) + this.index;
                    ...
                    var c = d.chart, e = c.components, g = a.parseUnsafeString,
                        x = d.config, p = d.JSONData, h = c.jsonData.chart, u = e.colorManager, m = d.index || d.stackIndex, n = d.type, v = !c.singleseries || z(h.palettecolors) ? u.getPlotColor(m) : u.getColor(l).split(/\s*\,\s*/)[0], m = p.data, y, A = c.config.categories, A = w(A && A.length, m && m.length), B = e.numberFormatter, D = c.use3dlineshift, C, K = -Infinity, V = Infinity, L, F, I = b(h.tooltipsepchar, ": "), P = f(p.dashed, h.linedashed);
                    F = c.isStacked;
                    y = c.hasLineSet;
                    e = e.xAxis[0];
                    ...
                    var c = d.chart, e = c.components, g = a.parseUnsafeString, h = d.config, p = d.JSONData, m = c.jsonData.chart, u = e.colorManager, n = d.index || d.stackIndex, v = d.type, y = !c.singleseries || z(m.palettecolors) ? u.getPlotColor(n) : u.getColor(l).split(/\s*\,\s*/)[0],
                        n = p.data, A, D = c.config.categories, D = w(D && D.length, n && n.length), B = e.numberFormatter, C = c.use3dlineshift, K, V = -Infinity, L = Infinity, F, I, P = b(m.tooltipsepchar, ": "), Z = f(p.dashed, m.linedashed);
                    I = c.isStacked;
                    A = c.hasLineSet;
                    e = e.xAxis[0];
                    d.visible = 1 === f(d.JSONData.visible, !Number(d.JSONData.initiallyhidden), 1);
                    ...
                    var c = d.chart, e = c.components, g = a.parseUnsafeString, h = d.config, p = d.JSONData, m = c.jsonData.chart, u = e.colorManager, n = d.index || d.stackIndex, v = d.type, y = !c.singleseries || z(m.palettecolors) ? u.getPlotColor(n) : u.getColor(l).split(/\s*\,\s*/)[0], n = p.data, A, D = c.config.categories, D = w(D && D.length, n && n.length), B = e.numberFormatter, C = c.use3dlineshift, K, V = -Infinity, L = Infinity, F, I, P = b(m.tooltipsepchar, ": "), Z = f(p.dashed, m.linedashed);
                    I = c.isStacked;
                    A = c.hasLineSet;
                    e = e.xAxis[0];
                    d.visible = 1 === f(d.JSONData.visible, !Number(d.JSONData.initiallyhidden), 1);
                    ...
                    var c = d.chart, e = c.components, h = a.parseUnsafeString, g = d.config, p = d.JSONData, m = c.jsonData.chart, u = e.colorManager, n = d.index || d.stackIndex, v = d.type,
                        y = !c.singleseries || z(m.palettecolors) ? u.getPlotColor(n) : u.getColor(l).split(/\s*\,\s*/)[0], n = p.data, A, D = c.config.categories, D = w(D && D.length, n && n.length), B = e.numberFormatter, C = c.use3dlineshift, K, V = -Infinity, L = Infinity, F, I, P = b(m.tooltipsepchar, ": "), Z = f(p.dashed, m.linedashed);
                    I = c.isStacked;
                    A = c.hasLineSet;
                    e = e.xAxis[0];
                    d.visible = 1 === f(d.JSONData.visible, !Number(d.JSONData.initiallyhidden), 1);
                    ...
                    var e = d.chart, g = e.components, h = a.parseUnsafeString, p = d.config, m = d.JSONData, u = e.jsonData.chart, n = g.colorManager, v = d.index || d.stackIndex, y = d.type, A = !e.singleseries || z(u.palettecolors) ? n.getPlotColor(v) : n.getColor(l).split(/\s*\,\s*/)[0], v = m.data, D, C = e.config.categories, C = w(C && C.length, v && v.length), B = g.numberFormatter, K = e.use3dlineshift,
                        V, L = -Infinity, F = Infinity, I, P, Z = b(u.tooltipsepchar, ": "), T = f(m.dashed, u.linedashed);
                    P = e.isStacked;
                    D = e.hasLineSet;
                    g = g.xAxis[0];
                    d.visible = 1 === f(d.JSONData.visible, !Number(d.JSONData.initiallyhidden), 1);
                    ...
                    var d = b.chart, c = d.components, f = d.hasLineSet, f = a.parentyaxis && a.parentyaxis.toLowerCase() === r || f ? 1 : 0;
                    b.chart = d;
                    b.yAxis = c.yAxis[f];
                    b.components = {};
                    b.graphics = {};
                    ...
                    d = p.data[d];
                    c = {};
                    var l = a.graphics.mapSymbolName, p = void 0 !== b(d.anchorstartangle, p.anchorstartangle, m.anchorstartangle, d.anchorimagealpha, p.anchorimagealpha, m.anchorimagealpha,
                            d.anchorimagescale, p.anchorimagescale, m.anchorimagescale, d.anchorimagepadding, p.anchorimagepadding, m.anchorimagepadding, d.anchorimageurl, p.anchorimageurl, m.anchorimageurl, d.meaniconradius, p.meaniconradius, m.meaniconradius, d.meaniconcolor, p.meaniconcolor, m.meaniconcolor, d.anchorbordercolor, p.anchorbordercolor, m.anchorbordercolor, d.anchoralpha, p.anchoralpha, m.anchoralpha, d.meaniconsides, p.meaniconsides, m.meaniconsides, d.anchorborderthickness, p.anchorborderthickness, m.anchorborderthickness, void 0), m =
                    ...
                    var a, b, c, g, l, p, r, u = this, y = u.JSONData, z = u.config, E = u.groupManager, K = u.index, V = u.chart.config.categories, P = y.data, H = V && V.length, T = P && P.length, M, N, R, J = u.visible, ga = u.chart, ka = ga.config, pa = ga.components.paper, Na = ga.components.xAxis[0], Ra = u.yAxis, Va = ga.graphics.columnGroup, Da, Ia, va = ga.graphics, Fa = z.showtooltip, wa = ga.get(e, ba), oa = wa.animType,
                        qa = wa.animObj, la = wa.dummyObj, ia = wa.duration, ea = Na.getAxisPosition(0), sa = Na.getAxisPosition(1) - ea, fa = z.definedGroupPadding, ha = z.plotSpacePercent / 200, ca = E.getDataSetPosition(u), Aa = z.maxcolwidth, ya = (1 - .01 * fa) * sa || w(sa * (1 - 2 * ha), 1 * Aa), Y = f(ca.columnWidth, ya / 1), ua, xa = ca.xPosOffset || 0, za = ca.height, Ga, Ma = u.components.data, ra, Ba, Ua, Ja, ja, xb, eb = Ra.getAxisBase(), Qb, Db, Kb = z.showShadow, pb = u.graphics.upperBoxContainer, hb = u.graphics.lowerBoxContainer, Eb = u.graphics.medianContainer, Fb = u.graphics.upperWhiskerContainer,
                        Lb = u.graphics.lowerWhiskerContainer, ib = u.graphics.dataLabelContainer, qb = u.graphics.shadowContainer, Ka, Xb, Mb, $a, Pb, yb, nb, Sa, Wa, ob, Jb, cb, Gb, jb, kb, zb, rb, Oa, fb, tb, Pa, sb, ab, na = ga.config.dataLabelStyle, Yb = va.datalabelsGroup, Ha = z.rotatevalues, lb = z.valuepadding, mb = ga.components.numberFormatter, bb = Ha ? d : "middle", Hb = ga.linkedItems.smartLabel, Ca, Za, Rb, Sb, Nb, Ob, Ya, Ib, gb, ub, vb, Tb, Zb, dc, Ub, jc = Infinity, Xa, ic, wb = !0, yc = (u.components.removeDataArr || []).length, kc, lc, mc, nc, oc, pc, qc, rc, sc, Vb, Wb, $b = z.showHoverEffect, Ab,
                    ...
                    var a =
                        this.components, b = a.removeDataArr, d = a.pool || (a.pool = {
                            element: [],
                            hotElement: [],
                            label: []
                        }), c = b.length, f, e = this.maxminFlag, g, h, m, l, n;
                    ...
                    var c = this.components, f = c.data, e = c.removeDataArr || (c.removeDataArr = []), g = c.mean.components.removeDataArr || (c.mean.components.removeDataArr = []), h = c.sd.components.removeDataArr || (c.sd.components.removeDataArr = []), m = c.md.components.removeDataArr || (c.md.components.removeDataArr = []), l = c.qd.components.removeDataArr || (c.qd.components.removeDataArr = []), n = this.config, r = this.groupManager, v =
                        this.maxminFlag;
                    d = d || 1;
                    a = a || 0;
                    ...
                    var d = this.JSONData, c = this.chart.jsonData.chart, e = this.config, g = e.upperBoxColor, h = this.chart.components.legend, m = b(d.outliericoncolor, c.outliericoncolor, E), d = {
                    ...
                    var b = this.config, c = d.config, f = d.graphics, e = b.itemHiddenStyle.color, b = b.itemStyle.color, g = c.fillColor, c = c.strokeColor, h, m;
                    a.visible =
                        a.visible ? !1 : !0;
                    ...
                    var b = this.config, c = a.visible, f = d.config, e = d.graphics, g = b.itemHiddenStyle.color, b = b.itemStyle, h = b.color, m = f.fillColor, f = f.strokeColor, l =
                        d.index, n = a.subDS;
                    c ? a.hide() : a.show();
                    ...
                    var a = this.graphics.upperBoxContainer, d = this.graphics.lowerBoxContainer, b = this.graphics.medianContainer,
                        c = this.graphics.upperWhiskerContainer, f = this.graphics.lowerWhiskerContainer, e = this.graphics.dataLabelContainer, g = this.graphics.shadowContainer, h = this.chart, m = this.yAxis;
                    h._chartAnimation();
                    this.visible = !0;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-subds", function () {
        J.register("component", ["dataset", "subDS", {
            show: function () {
                ...
                var E = this.config, e = a.visible, J = c.config, W = c.graphics, S = E.itemHiddenStyle.color, E = E.itemStyle.color, I = J.fillColor, B, X = J.strokeColor;
                e ? a.hide() : a.show();
                e = {
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-heatmap", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.colors.FFFFFF, e = c.configStr, ba = c.animationObjStr, W = c.showHoverEffectStr, S = c.columnStr, I = c.shadowStr, B = c.dataLabelStr, X = c.miterStr, M = c.hiddenStr, R = c.visibleStr, r = a.ZEROSTRING, D = c.pStr, v = c.sStr, A = c.POSITION_START, F = c.POSITION_TOP, l = c.POSITION_END, C = c.POSITION_BOTTOM, H = c.NORMAL, Q = a.BLANKSTRING, n = a.BLANKSTRING, b = a.pluck, z = a.getValidValue, f = a.pluckNumber, K = a.toRaphaelColor, V = a.regex.dropHash,
            m = a.HASHSTRING, Z = a.schedular, ga = function (a) {
                return void 0 !== a && null !== a
            }, L = "rgba(192,192,192," + (a.isIE ? .002 : 1E-6) + ")", c = a.TOUCH_THRESHOLD_PIXELS, w = a.CLICK_THRESHOLD_PIXELS, U = Math, g = U.round, y = U.min, P = U.max, ka = a.hasTouch ? c : w, d = a.setLineHeight, N = a.graphics.getLightColor, T = a.graphics.convertColor, h = a.HUNDREDSTRING;
        J.register("component", ["dataset", "HeatMap", {
            type: "heatmap", configure: function () {
                var c = this.chart, e = c.components, t = e.postLegendInitFn, m = e.gradientLegend, l = c.config.style, p = this.config, r = c.jsonData,
                    u = this.JSONData, w = u.data, A = c.singleseries, C = w && w.length, B = c.jsonData.chart, V = c.components.colorManager, L, F = p.plotColor = V.getPlotColor(this.index || this.positionIndex), I = f(u.dashed, B.plotborderdashed), U = f(B.useplotgradientcolor, 1), Z = f(B.showtooltip, 1), M = a.parseUnsafeString, R = M(B.yaxisname), S = M(B.xaxisname), W = M(b(B.tooltipsepchar, ": ")), J = a.parseTooltext, X, ga, ba, ka, Ia, va, Fa, wa, oa, qa, la, ia, ea, sa, fa, ha, ca, Aa, ya, Y, ua, xa, za, Ga = r.colorrange || {}, Ma = c.components.xAxis[0], ra = c.components.yAxis[0], Ba, Ua, Ja = p.mapByPercent =
                        f(Ga.mapbypercent, 0), ja = p.mapByCategory = f(B.mapbycategory, 0), xb = c.jsonData, eb = xb.colorrange && f(xb.colorrange.gradient), Qb = a.nonGradientColorRange, Db, Kb, pb, hb, Eb, Fb, Lb, ib, qb, Ka, Xb, Mb, $a, Pb = a.getDashStyle, yb = this.components.data, nb = this.components.plotGrid = [], Sa = c.components.numberFormatter, Wa, ob, Jb = c.isBar, cb = c.is3D, Gb, jb, kb, zb, rb, Oa, fb, tb, Pa = -Infinity, sb = Infinity, ab, na, Yb = z(B.tltype, Q), Ha = z(B.trtype, Q), lb = z(B.bltype, Q), mb = z(B.brtype, Q), bb, Hb, Ca, Za, Rb = Q, Sb = Q, Nb = Q, Ob = Q, Ya, Ib, gb, ub, vb, Tb, Zb = r.rows.row.length,
                ...
                var d =
                    this.chart, c = d.components, b = a.parentyaxis && a.parentyaxis.toLowerCase() === v ? 1 : 0, c = c.yAxis[b];
                if (!a)return !1;
                this.JSONData = a;
                this.yAxis = c;
                this.chartGraphics = d.chartGraphics;
                ...
                var a = this.components.data, d = this.chart, c = d.jsonData.chart, b, e, g = this.config.colorMap, l = this.components.colorRange, u, n, v, z;
                ...
                var c = this.config, b = a.config.visible, f = a.dataSet, e = d.config, g = d.graphics, h = c.itemHiddenStyle.color, c = c.itemStyle.color, m = e.fillColor, e = e.strokeColor;
                b ? f.hide(a) : f.show(a);
                ...
                var d = this.components.data, c = this.chart.get(e, ba), b = c.animType, f = c.animObj, g = c.dummyObj, c = c.duration, h = this.components.colorRange, m, l, n, r, v;
                r = a.config.code;
                m = 0;
                ...
                var d = this.components.data, c = this.config, b = this.chart.get(e, ba), f = b.animType, g = b.animObj, h = b.dummyObj, b = b.duration, m, l, n = this.components.colorRange,
                    r, v, z, w;
                z = a.config.code;
                r = 0;
                ...
                var c = this.config, b = this.chart.get(e, ba), f = b.animType, g = b.animObj, h = b.dummyObj, b = b.duration, m, l, n = this.components.data, r, v, z;
                r = 0;
                ...
                var f = this.components.plotGrid, e = this.chart.config, g = e.viewPortConfig, h = g.x, m = g.scaleX, g = e.plotborderthickness, e = e.showplotborder;
                a = f[d] && f[d][a];
                g =
                    e ? g : 0;
                d = g / 2;
                ...
                var b = this.chart, c = b.config, f = b.components.xAxis[0], e = b.components.canvas.config, e = Math.max(e.canvasPaddingLeft, e.canvasPadding), g = c.canvasLeft, b = b.components.yAxis[0].getValue(d + b.config.canvasHeight / b.jsonData.rows.row.length / 2 - c.canvasTop - e), c = Math.floor(b), f = f.getValue(a -
                    g - e), e = Math.round(f);
                ...
                var d = this.config, c = this.JSONData.data, b, f, g, h = this.visible, m = this.chart, l = m.getJobList(), r = m.components.paper, v = m.components.xAxis[0], z = m.components.yAxis[0], w =
                    m.components.gradientLegend;
                b = m.graphics.datasetGroup;
                var y, A, D = m.graphics, E = m.config.showtooltip, C = m.get(e, ba), V = C.animType, F = C.animObj, U = C.dummyObj, P = C.duration, N, H, T, Q = this.components.data, J;
                ...
                var ia, D = m.components.legend.config.isActive, ea = this.components.plotGrid, sa, fa, ha, ca = [], Aa = (this.components.removeDataArr || []).length, ya = d.showHoverEffect, Y;
            ...
            drawLabel: function () {
                var a = this.chart, d = a.config, c = a.graphics, b = a.components.paper, f = a.linkedItems.smartLabel, g = a.config.dataLabelStyle, h = this.config, m = this.JSONData.data.length, r = this.components.data, v = this.visible, z, w, y, D, E, K, V = this.graphics.dataLabelContainer, L = this.graphics.tlLabelContainer, I = this.graphics.blLabelContainer, U = this.graphics.trLabelContainer, P = this.graphics.brLabelContainer, H, N, Z, T, J, W, S, X, ka, wa, oa, qa, la, ia, a = a.get(e, ba), ea = a.animObj, sa = a.dummyObj, fa = a.duration, c = c.datalabelsGroup;
                ...
                var a = this.components, d = a.removeDataArr, c = a.pool || (a.pool = {
                        element: [],
                        hotElement: [],
                        label: []
                    }), b = d.length, f, e = this.maxminFlag, g, h, m;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-kagi", function () {
        var a = this.hcLib, c = this.window.Image, E = a.preDefStr, e = E.configStr, ba = E.animationObjStr, W = E.dataLabelStr, S = E.hiddenStr,
            I = E.ROUND, B = E.POSITION_TOP, X = E.POSITION_BOTTOM, M = E.line, R = a.BLANKSTRING, r = a.pluck, D = a.pluckNumber, v = a.toRaphaelColor, A = a.schedular, F = a.each, E = a.TOUCH_THRESHOLD_PIXELS, l = a.CLICK_THRESHOLD_PIXELS, C = Math, H = C.round, Q = C.min, n = C.max, b = C.abs, z = a.hasTouch ? E : l, f = a.POSITION_RIGHT;
        J.register("component", ["dataset", "Kagi", {
            type: "kagi", _parseShadowOptions: function () {
                ...
                b = l.chart;
                var w = b.getJobList(), D = b.components, g = b.config, y = l.config, E = y.trackIndex = {}, C = l.components, d = C.data, N = (C = C.removeDataArr) && C.length, J = d && d.length, C = d && d.length, h = D.paper, q = D.xAxis[0], k, t, D = b.graphics, O = D.datalabelsGroup, x, p, G, u, R, X, La =
                        l.components.data, aa, db, fc, ta = r.container, xc, gc = D.datasetGroup, Qa, D = y.shadow, Ea, ec = r.dataLabelContainer, Ta = {}, hc, pa, Na, Ra = function () {
                        ta.lineGroup.attr({"clip-rect": null});
                        ta.lineShadowGroup.show();
                        ta.anchorShadowGroup.show();
                        ta.anchorGroup.show();
                        ec && ec.show()
                    }, Va = !0, Da = q.getAxisPosition(0), Ia = q.getAxisPosition(1) - Da, va = {"clip-rect": [n(0, g.canvasLeft), n(0, g.canvasTop), n(1, g.canvasWidth), n(1, g.canvasHeight)]}, Fa = {"clip-rect": [n(0, g.canvasLeft), n(0, g.canvasTop), 1, n(1, g.canvasHeight)]}, g = y.rallyThickness,
                    wa = y.declineThickness, oa = {
                        ...
                        "true": g,
                        "false": wa
                    }, ia = [], ea = [], sa = r.rallyElem, fa = r.declineElem, ha = l.visible, ca = q.getAxisPosition(0), Aa = d[0] && !!d[0].isRally, ya, Da = Da - Ia / 2, Y, ua, xa, za = r.lineElement, Ga = l.pool || (l.pool =
                            {});
                b = b.get(e, ba);
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragnode", function () {
        var a = this.hcLib, c = a.preDefStr, E = c.colors, e = E.FFFFFF, ba = E.c000000, W = c.configStr, S = c.animationObjStr,
            I = a.BLANKSTRING, B = a.BLANKSTRING, X = a.pluck, M = a.getFirstValue, R = a.extend2, r = a.HASHSTRING, D = a.hashify, v = a.each, A = a.componentDispose, F = function (a) {
                return void 0 !== a && null !== a
            }, c = Math, l = c.min, C = c.max, H = a.hasTouch, Q = a.COMMASTRING, c = a.graphics, n = c.parseColor, b = c.getValidColor;
        J.register("component", ["datasetGroup", "Dragnode", {
            ...
            createHtmlDialog: function (a, b, c, l, m, n, v) {
                var A = a.components.paper, w = a.config.style.inCanvasStyle || {}, B = a.config.width, g = a.config.height, y = a.get(W, S).transposeAnimDuration, E = {
                    color: D(w.color),
                    textAlign: "center",
                    paddingTop: "1px",
                    border: "1px solid #cccccc",
            ...
            updateUIvisuals: function () {
                var a = this.graphics.cacheConnectorUpdateUI, b = this.chart, c = this.graphics.cacheLabelUpdateUI, e = this.graphics.cacheLabelDeleteUI, m = this.graphics.cacheUpdateUI;
            ...
            showLabelDeleteUI: function (a) {
                var b = this.chart, c = b.get(W, S).duration, e = b.components.paper, m = this.graphics.cacheLabelDeleteUI;
            ...
            showNodeUpdateUI: function () {
                var c = function () {
                    ...
                    var e = this.graphics.cacheUpdateUI,
                        f = b.config.height, l = e.fields.image.val(), n = c ? 300 : 0, r = ["imgWidth", "imgHeight", "imgAlign", "imgUrl"], g, v, z;
                    g = l ? 250 : 215;
                    e.ok.hide();
                    e.cancel.hide();
                    e.remove.hide();
                ...
                return function (a, b, n) {
                    var r = this, A = r.graphics, w = A.cacheUpdateUI, C = r.nodes, g = a.config, y = g.animation, D = a.components.paper, E = {
                        width: "80px",
                        border: "1px solid #cccccc",
                        fontSize: "10px",
                        lineHeight: "15px",
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragcolumn",
        function () {
            ...
            J.register("component", ["datasetGroup", "DragColumn", {
                getJSONData: function () {
                    var a = this.chart, E = a.components.dataset, a = a.jsonData && a.jsonData.dataset, J = [], S, I, B, X = E.length;
                    ...
                    B = this.chart.config;
                    var r, D, v = (a && a.length) - c, A, F = B.isDataRestored, l, C = E(1 / B.binSize * B.labelBinSize),
                        H, Q, n, b;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-dragarea", function () {
        ...
        J.register("component", ["datasetGroup", "DragArea", {
            getJSONData: function () {
                var c = this.chart, e = c.components.dataset, c = c.jsonData && c.jsonData.dataset, J = [], W, S, I, B = e.length;
    ...
    J.register("module", ["private", "modules.renderer.js-dataset-group-boxandwhisker2d", function () {
        ...
        J.register("component", ["datasetGroup", "boxandwhisker2d", {
            draw: function () {
                ...
                var M = M.datalabelsGroup, R = S.get(E, e), r = R.animType, D = R.animObj, v = R.dummyObj, R = R.duration;
